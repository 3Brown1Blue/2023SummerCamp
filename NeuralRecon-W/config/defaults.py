...
_CN.LIGHTNEUCONW.LOSS = CN()
_CN.LIGHTNEUCONW.LOSS.coef = 1.0
_CN.LIGHTNEUCONW.LOSS.igr_weight = 0.1
_CN.LIGHTNEUCONW.LOSS.mask_weight = 0.1
_CN.LIGHTNEUCONW.LOSS.depth_weight = 0.1
_CN.LIGHTNEUCONW.LOSS.floor_weight = 0.01
